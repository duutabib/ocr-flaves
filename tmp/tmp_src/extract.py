...
def main():
    ...
    clients = [
        ("LLaVA", ModelClient(base_url="http://localhost:11434", model_name="llava")),
        ("bakLLaVA", ModelClient(base_url="http://localhost:11435", model_name="bakllava"))
    ]
    
    # Example usage
    input_path = "/Users/duuta/ocr-flaves/ghana_invoice_samples"  # Can be a file or directory
